...
const nextConfig = {
  // GitHub Pages requires a static export; Docker production uses standalone.
  ...
  // Security headers must be configured at the CDN/hosting layer for Pages deployments.
  ...(!isGitHubPages && {
    async headers() {
